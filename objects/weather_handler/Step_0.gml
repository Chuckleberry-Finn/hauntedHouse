if (lighting_triggered) {
    ...
    if (lerp_time <= flash_duration) {
        ...
        global.shadow_color = make_color_rgb(
        ...
        global.shadow_alpha = lerp(previous_alpha, 0, lerp_time / flash_duration);
    }
        ...
        global.shadow_alpha = lerp(0, previous_alpha, (lerp_time - flash_duration) / flash_duration);
    } 
    
    else {
        global.shadow_alpha = previous_alpha;
        global.shadow_color = previous_color;
