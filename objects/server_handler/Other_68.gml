if (async_load[? "type"] == network_type_connect) {
    ...
    buffer_write(buffer, buffer_f32, new_player._x);
    buffer_write(buffer, buffer_f32, new_player._y);
    buffer_write(buffer, buffer_u32, new_player._room_id);
    buffer_write(buffer, buffer_f32, new_player._facing);
